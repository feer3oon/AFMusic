...
@app.on_message(filters.command(["حظر"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["الغاء حظر"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["blocked", "المحظورين", "blusers"]) & SUDOERS)
@language
